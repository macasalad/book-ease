          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col h-full">
              <div className="flex-grow space-y-8">
                <div>
                  <h2 className="text-[#8a8a8a] text-sm font-semibold uppercase tracking-wider mb-4">
                    Book Details
                  </h2>
                ...
                {!isOwner && (
                  <>
                    ...
                    <form action={startConversation}>
                      <button
                        type="submit"
                        className="px-6 py-4 rounded-full border-2 border-[#bc8a5f] text-[#bc8a5f] hover:bg-[#bc8a5f] hover:text-white font-bold transition-all flex items-center justify-center gap-2"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path
                            strokeLinecap="round"
