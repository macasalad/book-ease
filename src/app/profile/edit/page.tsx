...
export default async function EditProfilePage() {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-[#f2ece4] via-[#e2d9c8] to-[#d4e2d4] text-[#4a4a4a] overflow-hidden relative font-sans flex flex-col items-center justify-center p-6">
            {/* Background Decorative Circles (Exact match to Profile page) */}
            ...
            <div className="w-full max-w-2xl relative z-10">
                ...
                {/* Glass Container for the Form (Exact match to Profile page card) */}
                <div className="w-full p-8 md:p-12 rounded-[2rem] border border-white/60 bg-white/40 backdrop-blur-lg shadow-xl shadow-stone-200/50">
                    <div className="mb-8">
                        <h1 className="text-4xl font-bold tracking-tight text-[#4a4a4a]">Edit Profile</h1>
                        <p className="text-[#8a8a8a] mt-2 font-medium">Update your display name and biography</p>
                    </div>
